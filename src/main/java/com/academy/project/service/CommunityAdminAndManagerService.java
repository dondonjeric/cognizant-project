...
public interface CommunityAdminAndManagerService {
    public CommunityAdminAndManager updateComManager(CommunityAdminAndManager comManager, Long id) throws RecordNotFoundException, InvalidStringFormatException;
